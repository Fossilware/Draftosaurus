<?php
/**
 * START TRACKING - Diseño Profesional
 * Modo Seguimiento - Draftosaurus  
 */
...
if ($numPlayers < 2 || $numPlayers > 5) {
    redirect("../game-tracking.php?players=$numPlayers&error=invalidplayers");
}
...
try {
    ...
    $insertValues = [$sessionCode, 'tracking', 'waiting', $currentUser['id']];
    $placeholders = ['?', '?', '?', '?'];
...
<body>
    <div class="confirmation-card">
        ...
        <div class="card-body-custom">
            ...
            <a href="../game-board-tracking.php?session=<?php echo $sessionId; ?>" class="btn-start-game">
    ...
    <script>
        ...
        let c = 3;
        setInterval(() => {
            if (--c <= 0) location.href = '../game-board-tracking.php?session=<?php echo $sessionId; ?>';
...
<body>
    <div class="error-card">
        ...
        <a href="../game-tracking.php?players=2" class="btn btn-primary">Volver</a>
    </div>
</body>
</html>
<?php
