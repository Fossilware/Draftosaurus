...
<body>
    ...
    <div class="floating-container">
        ...
        <div class="container-header">
            <h1><i class="fas fa-gamepad me-3"></i>Configurar Partida</h1>
            <p>Modo Regular - Juego Completo Digitalizado</p>
        </div>
        ...
        <div class="container-content">
            ...
            <div class="info-alert">
                <div class="d-flex align-items-start">
                    ...
                    <div>
                        <strong style="color: #2d5016; font-size: 1.1rem;">Modo Regular:</strong>
                        <p class="mb-0 mt-1">Juego completo digitalizado donde podrás seleccionar y colocar dinosaurios siguiendo todas las reglas del juego original.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="option-item">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="timerEnabled">
                                <div>
                                    <strong><i class="fas fa-clock me-2"></i>Activar Temporizador</strong>
                                    <small>Cada jugador tendrá 60 segundos para realizar su jugada</small>
                                </div>
                            </label>
                        </div>
                    </div>
